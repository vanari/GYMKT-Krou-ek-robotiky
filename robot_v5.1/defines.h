...
// definovani serva
#define STRAIGHT    88  // pohled seshora - vetsi uhel odpovida vic doprava, mensi uhel vic doleva
#define MAXANG      57  // maximalni odchyleni

// definovani dalsiho
#define THRESHOLD   575
#define LAPS        2
#define MINSPEED    100 // max 255
